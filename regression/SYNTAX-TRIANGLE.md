...
| `hit` | `HIT_KW` | 46 | yes | exercised |
| `hit_elim` | `HIT_ELIM` | 12 | yes | exercised |
| `holds` | `HOLDS` | 396 | yes | exercised |
...
| `match` | `MATCH_KW` | 12 | yes | exercised |
