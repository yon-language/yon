...
| `hit` | `HIT_KW` | 32 | yes | exercised |
| `hit_elim` | `HIT_ELIM` | 12 | yes | exercised |
| `holds` | `HOLDS` | 388 | yes | exercised |
...
| `inductive` | `INDUCTIVE` | 4 | yes | exercised |
...
| `match` | `MATCH_KW` | 5 | yes | exercised |
...
| `return` | `RETURN` | 346 | yes | exercised |
