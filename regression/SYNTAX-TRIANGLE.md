...
| `hit` | `HIT_KW` | 22 | yes | exercised |
| `hit_elim` | `HIT_ELIM` | 9 | yes | exercised |
| `holds` | `HOLDS` | 385 | yes | exercised |
...
| `inductive` | `INDUCTIVE` | 2 | yes | exercised |
...
| `match` | `MATCH_KW` | 4 | yes | exercised |
...
| `return` | `RETURN` | 338 | yes | exercised |
