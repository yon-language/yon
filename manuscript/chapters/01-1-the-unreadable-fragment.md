<!-- DRAFT — voice & format specimen (Ch 1.1). Not yet canonical (awaiting voice review).
     The `.yon` snippet is GATED ✓ on the Mac (2026-06-26): `yoner_emit_mlir` exit 0,
     emitted `main` returns i32 0. Project: regression/book/jp/01_1_unreadable/.
     Style rules in force: no em-dashes; verdict written for the reader, not as an audit. -->
...
# Chapter 1.1 · The Unreadable Fragment
...
Gated on the Mac, it compiles, and the `main` it emits is exactly this:
